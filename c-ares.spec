...
Source0  : https://github.com/c-ares/c-ares/releases/download/v1.31.0/c-ares-1.31.0.tar.gz
Source1  : https://github.com/c-ares/c-ares/releases/download/v1.31.0/c-ares-1.31.0.tar.gz.asc
...
%setup -q -n c-ares-1.31.0
cd %{_builddir}/c-ares-1.31.0
pushd ..
cp -a c-ares-1.31.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719586612
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libcares.so.2.16.0
/usr/lib64/libcares.so.2
/usr/lib64/libcares.so.2.16.0
