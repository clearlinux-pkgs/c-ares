...
Source0  : https://github.com/c-ares/c-ares/releases/download/v1.32.1/c-ares-1.32.1.tar.gz
Source1  : https://github.com/c-ares/c-ares/releases/download/v1.32.1/c-ares-1.32.1.tar.gz.asc
...
%setup -q -n c-ares-1.32.1
cd %{_builddir}/c-ares-1.32.1
pushd ..
cp -a c-ares-1.32.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720450411
...
cp %{_builddir}/c-ares-%{version}/LICENSE.md %{buildroot}/usr/share/package-licenses/c-ares/aa1e10e004e8cf2bc455b862c292341d88c6757b || :
export GOAMD64=v2
GOAMD64=v3
pushd ../buildavx2/
%make_install_v3
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libcares.so.2.17.1
/usr/lib64/libcares.so.2
/usr/lib64/libcares.so.2.17.1

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/c-ares/aa1e10e004e8cf2bc455b862c292341d88c6757b
