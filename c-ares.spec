...
Source0  : https://github.com/c-ares/c-ares/releases/download/v1.34.5/c-ares-1.34.5.tar.gz
Source1  : https://github.com/c-ares/c-ares/releases/download/v1.34.5/c-ares-1.34.5.tar.gz.asc
...
%setup -q -n c-ares-1.34.5
cd %{_builddir}/c-ares-1.34.5
pushd ..
cp -a c-ares-1.34.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744121141
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libcares.so.2.19.4
