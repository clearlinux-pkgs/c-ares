...
Source0  : https://c-ares.haxx.se/download/c-ares-1.26.0.tar.gz
Source1  : https://c-ares.haxx.se/download/c-ares-1.26.0.tar.gz.asc
...
%prep
%setup -q -n c-ares-1.26.0
cd %{_builddir}/c-ares-1.26.0
pushd ..
cp -a c-ares-1.26.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706304787
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libcares.so.2.11.0
/usr/lib64/libcares.so.2
/usr/lib64/libcares.so.2.11.0
