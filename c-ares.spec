...
Source0  : https://github.com/c-ares/c-ares/releases/download/v1.32.2/c-ares-1.32.2.tar.gz
Source1  : https://github.com/c-ares/c-ares/releases/download/v1.32.2/c-ares-1.32.2.tar.gz.asc
...
%setup -q -n c-ares-1.32.2
cd %{_builddir}/c-ares-1.32.2
pushd ..
cp -a c-ares-1.32.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721054051
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libcares.so.2.17.2
/usr/lib64/libcares.so.2
/usr/lib64/libcares.so.2.17.2
