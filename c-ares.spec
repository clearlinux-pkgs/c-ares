...
Source0  : https://c-ares.haxx.se/download/c-ares-1.27.0.tar.gz
Source1  : https://c-ares.haxx.se/download/c-ares-1.27.0.tar.gz.asc
...
%prep
%setup -q -n c-ares-1.27.0
cd %{_builddir}/c-ares-1.27.0
pushd ..
cp -a c-ares-1.27.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708701102
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libcares.so.2.12.0
/usr/lib64/libcares.so.2
/usr/lib64/libcares.so.2.12.0
