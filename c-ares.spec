...
Source0  : https://github.com/c-ares/c-ares/releases/download/v1.32.3/c-ares-1.32.3.tar.gz
Source1  : https://github.com/c-ares/c-ares/releases/download/v1.32.3/c-ares-1.32.3.tar.gz.asc
...
%setup -q -n c-ares-1.32.3
cd %{_builddir}/c-ares-1.32.3
pushd ..
cp -a c-ares-1.32.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721831295
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libcares.so.2.17.3
/usr/lib64/libcares.so.2
/usr/lib64/libcares.so.2.17.3
