...
Source0  : https://github.com/c-ares/c-ares/releases/download/v1.34.3/c-ares-1.34.3.tar.gz
Source1  : https://github.com/c-ares/c-ares/releases/download/v1.34.3/c-ares-1.34.3.tar.gz.asc
...
%setup -q -n c-ares-1.34.3
cd %{_builddir}/c-ares-1.34.3
pushd ..
cp -a c-ares-1.34.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731435486
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libcares.so.2.19.2
/usr/lib64/libcares.so.2
/usr/lib64/libcares.so.2.19.2
