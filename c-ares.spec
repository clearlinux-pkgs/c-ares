...
Source0  : https://c-ares.haxx.se/download/c-ares-1.28.1.tar.gz
Source1  : https://c-ares.haxx.se/download/c-ares-1.28.1.tar.gz.asc
...
%prep
%setup -q -n c-ares-1.28.1
cd %{_builddir}/c-ares-1.28.1
pushd ..
cp -a c-ares-1.28.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711975921
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libcares.so.2.13.1
/usr/lib64/libcares.so.2
/usr/lib64/libcares.so.2.13.1
